// - ------------------------------------------------------------------------------------------ - //
#ifndef __GEL_RENDER_RENDERTARGET_OPENGL_FBO_H__
#define __GEL_RENDER_RENDERTARGET_OPENGL_FBO_H__
// - ------------------------------------------------------------------------------------------ - //
// Usage:
...
public:
	...
	inline static void UnBind( ) {
		_UnBind();
		Gel::Native[0].UpdateViewport();		// Reset glViewport to the whole Native Screen //
	}
