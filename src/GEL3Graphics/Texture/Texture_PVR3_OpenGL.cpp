...
//	}
	...
	for ( size_t MipMap = 0; MipMap < Texture->MipMapCount; MipMap++ ) {
/*
//	int MipMap = 0; {
#ifdef USES_PVRTC
...
*/
		...
		if ( TextureSize > Gel::MaxTextureSize ) {
			Log( "* NOTE: Mipmap %i omitted (TextureSize: %i | MaxTextureSize: %i)", MipMap, TextureSize, Gel::MaxTextureSize );
			OmittedTexture++;
		}
		else {
