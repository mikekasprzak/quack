...
#if defined(_WIN32) && !defined(__QT__) && !defined(UNDER_CE) && !defined(POWERVR_SDK_ONLY)	/* Windows desktop */
...
#if defined(_WIN32) && !defined(__QT__) && !defined(POWERVR_SDK_ONLY)

#else
#if defined(__linux__) || defined(__APPLE__) || defined(POWERVR_SDK_ONLY)
